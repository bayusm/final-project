...
public class TFRedo extends TFBaseImageButton {
    @NonNull
    @Override
    public View createToolView(TextEditor textEditor) {
        ImageButton imageButton = createBaseImageButton(textEditor.requireContext(), R.drawable.ic_tool_redo);
        imageButton.setOnClickListener(v -> textEditor.getRichEditor().redo());
        return imageButton;
    }
}