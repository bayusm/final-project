...
public class TFListBullet extends TFBaseImageButton {

    @NonNull
    @Override
    public View createToolView(TextEditor textEditor) {
        ImageButton toolView = createBaseImageButton(textEditor.requireContext(), R.drawable.ic_tool_list_bullet);
        toolView.setOnClickListener(v -> textEditor.getRichEditor().setBullets());
        return toolView;
    }
}
