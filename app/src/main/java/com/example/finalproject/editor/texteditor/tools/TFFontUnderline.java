...
public class TFFontUnderline extends TFBaseImageButton {

    @NonNull
    @Override
    public View createToolView(TextEditor textEditor) {
        ImageButton toolView = createBaseImageButton(textEditor.requireContext(), R.drawable.ic_tool_font_underline);
        toolView.setOnClickListener(v -> textEditor.getRichEditor().setUnderline());
        return toolView;
    }
}
