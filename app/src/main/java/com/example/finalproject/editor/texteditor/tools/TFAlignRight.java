...
public class TFAlignRight extends TFBaseImageButton {

    @NonNull
    @Override
    public View createToolView(TextEditor textEditor) {
        ImageButton toolView = createBaseImageButton(textEditor.requireContext(), R.drawable.ic_tool_align_right);
        toolView.setOnClickListener(v -> textEditor.getRichEditor().setAlignRight());
        return toolView;
    }
}
